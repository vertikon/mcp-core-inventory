# 🔍 Ferramenta de Validação de Árvore - mcp-core-inventory

**Ferramenta:** `validate-tree`  
**Versão:** 1.0  
**Propósito:** Validar conformidade estrutural do projeto mcp-core-inventory
...
1. **Árvore Original** (`mcp-core-inventory-ARVORE-FULL.md`) - Fonte única da verdade
...
./bin/validate-tree \
  --original .cursor/mcp-core-inventory-ARVORE-FULL.md \
...
|------|-----------|--------|
| `--original`, `-o` | Caminho para árvore original | `.cursor/mcp-core-inventory-ARVORE-FULL.md` |
...
ls -la .cursor/mcp-core-inventory-ARVORE-FULL.md
...
- `.cursor/MAPA-DIFERENCAS-mcp-core-inventory.md` - Mapa completo de diferenças
