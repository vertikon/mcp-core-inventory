...
Este documento demonstra como usar o sistema RAG do mcp-core-inventory.
...
import (
    "context"
    "github.com/vertikon/mcp-core-inventory/internal/ai/knowledge"
)
...
func main() {
    ...
    documents := []string{
        ...
        "O mcp-core-inventory implementa o protocolo MCP usando Go...",
        "A arquitetura do mcp-core-inventory segue Clean Architecture...",
    }
...
import (
    "context"
    "github.com/vertikon/mcp-core-inventory/internal/ai/rag"
)
...
func main() {
    ...
    // Query com contexto
    query := "Explique a arquitetura do mcp-core-inventory"
...
```
Response: O mcp-core-inventory implementa o protocolo MCP usando Go e segue Clean Architecture...
