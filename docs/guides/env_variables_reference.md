# Referência de Variáveis de Ambiente - mcp-core-inventory

Este documento lista todas as variáveis de ambiente disponíveis no mcp-core-inventory.
...
| Variável | Descrição | Default | Obrigatório |
|----------|-----------|---------|-------------|
| `HULK_MCP_SERVER_NAME` | Nome do servidor MCP | `mcp-core-inventory` | Não |
