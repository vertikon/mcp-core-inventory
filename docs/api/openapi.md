...
Este documento descreve a documentação OpenAPI do mcp-core-inventory.

## Visão Geral

A API HTTP do mcp-core-inventory é documentada usando OpenAPI 3.0, permitindo geração automática de clientes e documentação interativa.
