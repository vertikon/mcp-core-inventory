# 📚 ÍNDICE DE DOCUMENTOS DE AUDITORIA - mcp-core-inventory
...
#### 1. **MAPA DE DIFERENÇAS — mcp-core-inventory**
📄 `.cursor/MAPA-DIFERENCAS-mcp-core-inventory.md`
...
📄 `.cursor/mcp-core-inventory-ARVORE-FULL.md`

**Descrição:** Árvore oficial normativa do projeto mcp-core-inventory
...
4. **Consultar:** `.cursor/MAPA-DIFERENCAS-mcp-core-inventory.md`
...
3. **Referenciar:** `.cursor/MAPA-DIFERENCAS-mcp-core-inventory.md`
...
1. **Referenciar:** `.cursor/mcp-core-inventory-ARVORE-FULL.md` (árvore oficial)
