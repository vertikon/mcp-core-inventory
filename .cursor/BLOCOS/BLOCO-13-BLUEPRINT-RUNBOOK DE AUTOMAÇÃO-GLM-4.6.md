...
*   **mcp-core-inventory:** Nome do ecossistema.
...
**Nota Final:** Este é um **documento vivo**. Sempre que um script for adicionado, modificado ou removido, este runbook deve ser atualizado. A precisão aqui é a chave para a operação segura e eficiente do mcp-core-inventory.