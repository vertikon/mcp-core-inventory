...
Segundo o documento de integrações **mcp-core-inventory-INTEGRACOES.md**, o BLOCO-4 é a **camada de Domínio**, responsável por **regras de negócio puras**, **entidades**, **value objects**, e **interfaces de repositório**.
...
```
docs/blueprints/mcp-core-inventory-BLOCO-4.md
```

Este é o **documento final, normativo, canônico e estável**, considerado **fonte única da verdade** para o Domínio do mcp-core-inventory.

---

# 🟦 **mcp-core-inventory — BLOCO-4 BLUEPRINT OFICIAL**
...
O **Bloco-4 (Domain Layer)** é a fundação lógica do mcp-core-inventory.
Aqui vivem:
...
Segundo **mcp-core-inventory-INTEGRACOES.md**:
...
ou
📘 **mcp-core-inventory-BLUEPRINT-FULL.md (v1)**
