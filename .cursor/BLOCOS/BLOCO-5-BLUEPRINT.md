...
**`mcp-core-inventory-ARVORE-FULL.md`**, nas linhas **L29–L49**, que definem a estrutura e responsabilidade do BLOCO-5.
Citação direta:
...
```
docs/blueprints/mcp-core-inventory-BLOCO-5.md
```

---

# 🟪 **mcp-core-inventory — BLOCO-5 BLUEPRINT OFICIAL**
...
**Fonte de verdade:** mcp-core-inventory-ARVORE-FULL.md
