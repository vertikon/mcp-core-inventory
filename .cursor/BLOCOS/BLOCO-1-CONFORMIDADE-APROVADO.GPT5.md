...
```
docs/blueprints/mcp-core-inventory-BLOCO-1.md
```

---

# 🟩 **mcp-core-inventory — BLOCO-1 BLUEPRINT OFICIAL**
...
O **Bloco-1 (Core Platform)** é o *runtime fundacional* do ecossistema mcp-core-inventory.
...
Conforme a árvore mcp-core-inventory:
