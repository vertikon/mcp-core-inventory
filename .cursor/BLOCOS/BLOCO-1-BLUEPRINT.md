...
Conforme `mcp-core-inventory-ARVORE-FULL.md`, o Bloco-1 engloba:
...
* `docs/blueprints/`
* `mcp-core-inventory-BLOCO-1.md`
* Ou como seção dentro de `mcp-core-inventory-BLUEPRINT-FULL.md`
...
O **Bloco-1 (Core Platform)** é a camada fundamental que sustenta todo o ecossistema **mcp-core-inventory**. Ele é responsável por:
...
E:\vertikon\.templates\mcp-core-inventory\
...
*(Conforme `mcp-core-inventory-INTEGRACOES.md`)*
