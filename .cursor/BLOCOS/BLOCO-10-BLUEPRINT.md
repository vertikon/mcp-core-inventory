...
A estrutura oficial está na **Árvore mcp-core-inventory**, em:
...
Segundo **mcp-core-inventory-INTEGRACOES**:
...
Conforme mcp-core-inventory-INTEGRACOES:
...
Perfeito.
A seguir está o **DOCUMENTO OFICIAL — BLOCO-10 (TEMPLATES)**, totalmente normativo, no **padrão Vertikon / mcp-core-inventory**, pronto para ser incluído em:

```
docs/blueprints/mcp-core-inventory-BLOCO-10.md
```

Este documento está **congelado**, **estável**, **canônico**, e segue rigorosamente a **Árvore Oficial**, o documento **mcp-core-inventory-INTEGRACOES.md** e os blueprints **BLOCO-10-11-V1/V2**.

---

# 🟦 **mcp-core-inventory — BLOCO-10 BLUEPRINT OFICIAL**
...
Extraído diretamente de **mcp-core-inventory-INTEGRACOES.md**.
...
### 👉 **Gerar o mcp-core-inventory-BLUEPRINT-FULL.md (versão consolidada)**
